                            ...
                            !emailSent ? (
                                <form onSubmit={submitHandler}>
                                    ...
                                    <label className='relative w-full'>
                                        ...
                                        <p className='text-[0.875rem] text-black mb-1 leading-[1.375rem]'>New Password
                                        <sup className='text-pink-200'>*</sup></p>

                                        <input className='w-full bg-white rounded-[0.5rem] text-black p-[12px] drop-shadow-[0_2px_rgba(255,255,255,0.25)] mb-6'
                                    ...
                                    <label className='relative w-full'>
                                        ...
                                        <p className='text-[0.875rem] text-black mb-1 leading-[1.375rem]'>Confirm New Password
                                        <sup className='text-pink-200'>*</sup></p>
                                        ...
                                        <span className='absolute text-[#208486] right-3 -bottom-[4px] cursor-pointer'
                                    ...
                                    <button type='submit'
                                            className='bg-[#20B486] text-white w-full
